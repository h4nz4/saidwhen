# bundle-validation Specification

## Purpose
TBD - created by syncing change build-provenance-repo. Defines the bundle validator CLI, its validation rules, encoding tolerance, and test suite.
