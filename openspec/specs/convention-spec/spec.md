# convention-spec Specification

## Purpose
TBD - created by syncing change build-provenance-repo. Defines the Provenance Convention document (CONVENTION.md): bundle layout, concept types, provenance linking rules, and decision lifecycle semantics.
