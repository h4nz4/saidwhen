...
## Purpose
TBD - created by syncing change build-provenance-repo. Defines the tool-specific adapters (AGENTS.md snippet, Claude Code skills, OpenSpec skill pack) that bind the behaviors to concrete agent tooling.
